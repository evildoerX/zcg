    ...
    <div class="order_page">
        ...
        <ul class="order_list_ul" v-load-more="loaderMore">
            <li class="order_list_li" v-for="item in orderList" :key="item.id">
                <img :src="getImage(item.restaurant_image_url)" class="restaurant_image">
    ...
    export default {
      data(){
        ...
        methods: {
            ...
            getImage (url) {
                return require('../../images/idg/shop/1.png')
            }
        },
        watch: {
        ...
        .order_list_li{
            ...
            .order_item_right{
                ...
                .order_again{
                    ...
                    line-height: 1.6rem;
                    .buy_again{
                        @include sc(.55rem, #F4D87C);
                        border: 0.025rem solid #F4D87C;
                        padding: .1rem .2rem;
                        border-radius: .15rem;
                    }
                }
