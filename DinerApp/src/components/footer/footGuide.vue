<template>
    <section id='foot_guide'>
        ...
        <section @click = "gotoAddress({path: '/msite', query: {geohash}})" class="guide_item">
            <img class="icon_style" :src="mSiteSrc" />
            <span>外卖</span>
        </section>
        <section @click = "gotoAddress('/order')" class="guide_item">
        	<img class="icon_style" :src="orderSrc" />
            <span>订单</span>
        </section>
        <section @click = "gotoAddress('/profile')" class="guide_item">
        	<img class="icon_style" :src="profileSrc" />
            <span>我的</span>
        </section>
    </section>
</template>
...
<script>
    ...
    export default {
        ...
        computed: {
            ...
            mSiteSrc () {
                return this.$route.path.indexOf('msite') !== -1 ? require('../../images/idg/tab/index_select.png') : require('../../images/idg/tab/index.png')
            },
            orderSrc () {
                return this.$route.path.indexOf('order') !== -1 ? require('../../images/idg/tab/order_select.png') : require('../../images/idg/tab/order.png')
            },
            profileSrc () {
                return this.$route.path.indexOf('profile') !== -1 ? require('../../images/idg/tab/mine_select.png') : require('../../images/idg/tab/mine.png')
            }
        },
        methods: {
        	gotoAddress(path){
